  ...
  <section class="intro-section">
    ...
    <div class="intro-right">
      <p class="lead fw-light mb-2 text-justify-only"><strong>
        ...
        I’m Mulimbika Makina, a Data Scientist with a BSc in Mathematics (Statistics) and an MSc in Mathematics (Data Science), applying mathematical and statistical rigor to generate actionable insights from complex data.
      </strong></p>

      <p class="text-muted mb-0 text-justify-only">
        <strong>Python</strong>, <strong>SQL</strong>, <strong>R</strong>,
      ...
      <div class="d-flex justify-content-center mt-4">
        <div class="d-flex gap-3 mt-4 flex-wrap justify-content-start">
          <a href="projects.qmd" class="btn btn-primary px-4 py-2 fw-semibold">
            View Projects
          </a>

          <a href="resume.qmd" class="btn btn-outline-primary px-4 py-2 fw-semibold">
            View Resume
          </a>
        </div>
      </div>
